document.addEventListener('DOMContentLoaded', function () {
    ...
    let month = ["Sty", "Lut", "Mar", "Kwi", "Maj", "Cze", "Lip", "Sie", "Wrz", "PaĹş", "Lis", "Gru"];
    let monthLong = ["Stycznia", "Lutego", "Marca", "Kwietnia", "Maja", "Czerwca", "Lipca", "Sierpnia", "Września", "Października", "Listopada", "Grudnia"];
    ...
    function printDetails() {
        ...
        let date02 = new Date(start + 1 * day);
        let date03 = new Date(start + 2 * day);
        let date04 = new Date(start + 3 * day);
        let date05 = new Date(start + 5 * day);
        let date06 = new Date(start + 11 * day);
        let date07 = new Date(start + 13 * day);
        let date08 = new Date(start + 25 * day);
        let date09 = new Date(start + 15 * day);
        let date10 = new Date(start + 22 * day);
        let date11 = new Date(start + 20 * day);
        let date12 = new Date(start + 27 * day);
        let date13 = new Date(start + 29 * day);
        let date14 = new Date(start + 28 * day);
        let date15 = new Date(start + 34 * day);
        let date16 = new Date(start + 44 * day);
        let date17 = new Date(start + 47 * day);
        let date18 = new Date(start + 55 * day);
        let date19 = new Date(start + 49 * day);
        let date20 = new Date(start + 63 * day);
        let date21 = new Date(start + 64 * day);
        let date22 = new Date(start + 63 * day);
        let date23 = new Date(start + 64 * day);
